...
const SHADOW_MAP = {
  none:   '',
  accent: '0 0 20px rgba(200,255,0,0.25)',
  white:  '0 0 20px rgba(255,255,255,0.08)',
  strong: '0 0 40px rgba(200,255,0,0.45)',
};

const BORDER_MAP = {
  default: '1px solid #222',
  accent:  '1px solid rgba(200,255,0,0.5)',
  thick:   '3px solid #444',
  none:    'none',
};
...
export function applyProfileStyle(user) {
  ...
  const shadow = SHADOW_MAP[user.profileShadow || 'none'];
  const border = BORDER_MAP[user.profileBorder || 'default'];
