...
export function initStyleTab() {
  ...
  document.querySelectorAll('#radiusOptions .bg-option').forEach(o =>
    o.classList.toggle('selected', o.dataset.radius === r));
  document.querySelectorAll('#shadowOptions .bg-option').forEach(o =>
    o.classList.toggle('selected', o.dataset.shadow === s));
  document.querySelectorAll('#borderOptions .bg-option').forEach(o =>
